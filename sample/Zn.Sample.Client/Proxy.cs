...
{
    /// <summary />
    public class SampleSvcClient : ServiceClient
    {
        /// <summary />
        public SampleSvcClient() : base( "Sample" )
        {
        }
    ...
    public partial class OneClient : ServiceClient
    {
        ...
        /// Third method of service one.
        /// </summary>
        public Task<OneSvc.MethodThreeResponse> MethodThreeAsync( OneSvc.MethodThreeRequest request, CancellationToken cancellationToken )
        {
            return InvokeAsync<OneSvc.MethodThreeRequest, OneSvc.MethodThreeResponse>( "MethodThree", request, cancellationToken );
        }
    }
    ...
    public partial class TwoClient : ServiceClient
    {
        ...
        /// First method of service two.
        /// </summary>
        public Task<TwoSvc.MethodTwoResponse> MethodTwoAsync( TwoSvc.MethodTwoRequest request, CancellationToken cancellationToken )
        {
            return InvokeAsync<TwoSvc.MethodTwoRequest, TwoSvc.MethodTwoResponse>( "MethodTwo", request, cancellationToken );
        }
    }
